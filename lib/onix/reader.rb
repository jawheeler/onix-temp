  ...
  class Reader
    ...
    def initialize(input, product_klass = ::ONIX::Product)
      if input.kind_of?(String)        
        @reader = LibXML::XML::Reader.file(input, :options => LibXML::XML::Parser::Options::NOENT | LibXML::XML::Parser::Options::DTDLOAD)
      elsif input.kind_of?(IO)
        @reader = LibXML::XML::Reader.io(input, :options => LibXML::XML::Parser::Options::NOENT | LibXML::XML::Parser::Options::DTDLOAD)
      else
